...
public class PersonController {
    ...
    @RequestMapping(value = "/People", method = RequestMethod.POST, headers = {"Content-type=application/json"})
    @ResponseBody
    ...
    void removePersonTasks(@PathVariable("id") long id) {
        personRepository.findById(id).ifPresent(entity -> {
    ...
    @RequestMapping(value = "/People/{id}/tasks", method = RequestMethod.POST, headers = {"Content-type=application/json"})
    @ResponseBody
    ...
    @RequestMapping(value = "/People/{id}/task", method = RequestMethod.POST, headers = {"Content-type=application/json"})
    public @ResponseBody
